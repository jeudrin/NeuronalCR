...
namespace NeuronalCR
{
    public partial class Form1 : Form
    {
        ...
        static Retropropagacion backpropagation;
        ...
        public void createCharactersTable()
        {
        ...
        public List<List<double>> getEntryData(String character, List<double> entryData)
        {
            ...
            entryCharacter.agregarEntrada(new PatronItem("x1", (int)entryData.ElementAt(0)));
            entryCharacter.agregarEntrada(new PatronItem("x2", (int)entryData.ElementAt(1)));
            entryCharacter.agregarEntrada(new PatronItem("x3", (int)entryData.ElementAt(2)));
            entryCharacter.agregarEntrada(new PatronItem("x4", (int)entryData.ElementAt(3)));
            entryCharacter.agregarEntrada(new PatronItem("x5", (int)entryData.ElementAt(4)));
            entryCharacter.agregarEntrada(new PatronItem("x6", (int)entryData.ElementAt(5)));
            entryCharacter.agregarEntrada(new PatronItem("x7", (int)entryData.ElementAt(6)));
            entryCharacter.agregarEntrada(new PatronItem("x8", (int)entryData.ElementAt(7)));
            entryCharacter.agregarEntrada(new PatronItem("x9", (int)entryData.ElementAt(8)));
            entryCharacter.agregarEntrada(new PatronItem("x10", (int)entryData.ElementAt(9)));
            entryCharacter.agregarEntrada(new PatronItem("x11", (int)entryData.ElementAt(10)));
            entryCharacter.agregarEntrada(new PatronItem("x12", (int)entryData.ElementAt(11)));
            entryCharacter.agregarEntrada(new PatronItem("x13", (int)entryData.ElementAt(12)));
            entryCharacter.agregarEntrada(new PatronItem("x14", (int)entryData.ElementAt(13)));
            entryCharacter.agregarEntrada(new PatronItem("x15", (int)entryData.ElementAt(14)));
            entryCharacter.agregarEntrada(new PatronItem("x16", (int)entryData.ElementAt(15)));
            entryCharacter.agregarEntrada(new PatronItem("x17", (int)entryData.ElementAt(16)));
            entryCharacter.agregarEntrada(new PatronItem("x18", (int)entryData.ElementAt(17)));
            entryCharacter.agregarEntrada(new PatronItem("x19", (int)entryData.ElementAt(18)));
            entryCharacter.agregarEntrada(new PatronItem("x20", (int)entryData.ElementAt(19)));
            entryCharacter.agregarEntrada(new PatronItem("x21", (int)entryData.ElementAt(20)));
            entryCharacter.agregarEntrada(new PatronItem("x22", (int)entryData.ElementAt(21)));
            entryCharacter.agregarEntrada(new PatronItem("x23", (int)entryData.ElementAt(22)));
            entryCharacter.agregarEntrada(new PatronItem("x24", (int)entryData.ElementAt(23)));
            entryCharacter.agregarEntrada(new PatronItem("x25", (int)entryData.ElementAt(24)));
            entryCharacter.agregarEntrada(new PatronItem("x26", (int)entryData.ElementAt(25)));
            entryCharacter.agregarEntrada(new PatronItem("x27", (int)entryData.ElementAt(26)));
            entryCharacter.agregarEntrada(new PatronItem("x28", (int)entryData.ElementAt(27)));
            entryCharacter.agregarEntrada(new PatronItem("x29", (int)entryData.ElementAt(28)));
            entryCharacter.agregarEntrada(new PatronItem("x30", (int)entryData.ElementAt(29)));
            entryCharacter.agregarEntrada(new PatronItem("x31", (int)entryData.ElementAt(30)));
            entryCharacter.agregarEntrada(new PatronItem("x32", (int)entryData.ElementAt(31)));
            entryCharacter.agregarEntrada(new PatronItem("x33", (int)entryData.ElementAt(32)));
            entryCharacter.agregarEntrada(new PatronItem("x34", (int)entryData.ElementAt(33)));
            entryCharacter.agregarEntrada(new PatronItem("x35", (int)entryData.ElementAt(34)));
            entryCharacter.agregarEntrada(new PatronItem("x36", (int)entryData.ElementAt(35)));
